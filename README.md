...
uses automatic JavaScript injection, Pageview's self-managed Plausible Community
Edition provides a second pageview measurement, and Google Search Console is
verified with the apex-domain TXT record. Do not remove that verification record.
