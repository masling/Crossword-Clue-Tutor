...
function pageTemplate({ title, description, route, body, bodyClass = "", noindex = false, jsonLd = [] }) {
  ...
  const googleAnalyticsMarkup = googleAnalytics?.measurementId
...
await writePage(vocabularyGuideRoute, pageTemplate({ title: "Crossword clues for vocabulary learning", description: vocabularyGuideDescription, route: vocabularyGuideRoute, body: vocabularyGuideBody, bodyClass: "prose-page-body guide-page", jsonLd: [vocabularyGuideLd] }), false, "2026-08-22");
