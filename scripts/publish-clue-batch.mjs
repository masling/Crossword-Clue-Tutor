...
const [currentClues, answers, clueTypes, publications, clueHubs, classroomClues, config, input] = await Promise.all([
...
const result = validateContent({ clues: mergedClues, answers, clueTypes, publications, clueHubs, classroomClues, config: nextConfig });
