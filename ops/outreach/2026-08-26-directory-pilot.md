...
- Canonical URL: `https://crosswordcluetutor.com/`.
- Public name: Crossword Clue Tutor.
- Product: free browser-based crossword solver, reviewed explanation library, and Grades 6–12 vocabulary resource.
- Evidence: 169 reviewed public clue explanations, 110 answer-meaning pages, 500 original reviewed classroom clues, and 29 skill packs as of 2026-08-25.
- No publisher affiliation, AI-product claim, customer/traffic claim, testimonial, ranking claim, or complete commercial puzzle was submitted.
...
- Live verification: public submission routes, current terms, costs, account boundaries, form fields, and directory surfaces observed on 2026-08-25/26.
- Duplicate checks: project outreach records plus public exact-name searches; no existing Crossword Clue Tutor listing found on the five targets.
